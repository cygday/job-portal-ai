...
const state = { category: 'All', keyword: '', location: '', sort: 'recent', matching: false, saved: new Set(JSON.parse(localStorage.getItem('saved') || '[]')), profile: JSON.parse(localStorage.getItem('profile') || 'null') };
